...
import { findProductById } from '../../../State/Coutumers/Product/Action'
import { addItemToCart } from '../../../State/Coutumers/Cart/Action'

import { useEffect } from 'react'

import { gounsPage1 } from '../../../Data copy/Gouns/gouns'
...
export default function ProductDetails() {
  ...
  console.log("product detail", params.productId)
              ...
              <Grid item xs={5}>
                ...
                <Box>
                  ...
                  >
                    ...
                    <Grid item xs={2}>
                      <p className="opacity-50 p-2">18259</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
